...
Board.prototype.countFreeSpaces = function(tiles) {
...
Board.prototype.countFreeSpacesAfterValidMoves = function() {
	var self = this;
	var result = {};
	...
	_.each([LEFT, RIGHT, UP, DOWN], function(direction) {
		if (self.isMoveValid(direction)) {
			var tiles = _.cloneDeep(self.tiles);
			self._moveTiles(tiles, direction);
			result[direction] = Board.prototype.countFreeSpaces(tiles) - 1;
		}
	});
